 ...
 */
public class NumberPickerAvisoMinutosPreference extends DialogPreference {
    private static final int MAX = 500;
    private static final int MIN= 1;
    private static final String KEY = "PREF_AVISO_LIMITE_MINUTOS";
    private static final String DEFAULT= "90";
